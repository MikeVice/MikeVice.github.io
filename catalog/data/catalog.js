window.catalog = [{
    ...
    colors: ['Black', 'White'],
    sizes: ['UK 18'],
    thumbnail: './img/bohemian-print.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Blue'],
    sizes: ['UK 18'],
    thumbnail: './img/levis-jeans.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 17'],
    thumbnail: './img/friends.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    colors: ['Dark Blue'],
    sizes: ['UK 19'],
    thumbnail: './img/knee-jean.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
    ...
    sizes: ['UK 18', 'UK 19'],
    thumbnail: './img/cardigan.png', // replace with image extracted from item layout
    preview: ['full image path 1', 'full image path 2', 'full image path 3'] // replace with paths to images extracted from item layout
}, {
