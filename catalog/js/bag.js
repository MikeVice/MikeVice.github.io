...
function init() {
  ...
  if (resP.toString().indexOf(".")==-1) {resP = resP+".00";
} else {
...
var removeDiv = function(ax) {
  ...
  remove = document.getElementsByClassName("bag-list__remove");
  init();
}
...
buttonClear.addEventListener('click', function(){document.getElementsByClassName("bag-list")[0].innerHTML="<h2 class=\"bag-list__title secondary-title\">Your shopping bag is empty. Use Catalog to add new items</h2>"; init();}, false);
